...
import AdPreviewSidebar from "@/components/ad-preview-sidebar"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="border-t border-border pt-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Use Google Places API for precise location targeting
                    </p>
                  </div>
                </div>
          ...
          <div>
            <AdPreviewSidebar
              ...
              title={productTitle || "Your Product Title"}
              price={productPrice ? `${currency} ${productPrice}` : ""}
              description={productDescription || "Describe your product features and benefits..."}
